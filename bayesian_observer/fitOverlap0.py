...
dview.execute('objfun = build_objfun(psych0, psych1, speedSamp, nBlock)')
...
muzz0 = xx[2]*xx[9]-xx[0:5]*xx[7:12] 
sigzz0 = np.sqrt(xx[7:12] + xx[9])
muzz1 = xx[4]*xx[11]-xx[2:7]*xx[9:14] 
sigzz1 =  np.sqrt(xx[9:14] + xx[11])
