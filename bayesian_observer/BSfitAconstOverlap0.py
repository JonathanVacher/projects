...
for rep in range(REP):
    ...
    dview.execute('objfun = build_objfun_Aconst(psych00, psych11, speedSamp, nBlock)')
    ...
    muzz1BS[:,rep] = xxBS[0,rep]*xxBS[5,rep]-xxBS[0,rep]*xxBS[3:8,rep] 
    sigzz1BS[:,rep] =  np.sqrt(xxBS[3:8,rep] + xxBS[5,rep])
