...
for rep in range(REP):
    ...
    dview.execute('objfun = build_objfun1(psych00, speedSamp, nBlock)')
    ...
    muzz0BS[:,rep] = xxBS[2,rep]*xxBS[7,rep]-xxBS[0:5,rep]*xxBS[5:10,rep] 
    sigzz0BS[:,rep] = np.sqrt(xxBS[5:10,rep] + xxBS[7,rep])
